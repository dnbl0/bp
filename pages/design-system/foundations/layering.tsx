...
const Layering: NextPageWithLayout = () => (
    <DesignSystemLayout title="Layering" toc={toc}>
        <PageHeader
            eyebrow="Foundations"
            title="Layering"
            status="stable"
        ...
        <Section id="stacking" title="Stacking">
            <div className="relative h-48 rounded-xl border border-cool-paper-200 dark:border-charcoal bg-cool-paper-100 dark:bg-cool-grey overflow-hidden">
