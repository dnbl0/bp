...
/** Build an asset list from named files like Heart.png, Air-conditioning.png. */
const named = (dir: string, names: string[], alt = 'icon'): AssetImage[] =>
    names.map(name => ({
        src: `${BASE}/${dir}/${name}.png`,
        alt: `${name.replace(/-/g, ' ')} ${alt}`,
    }))
...
/** The Bupa navigation icon library (public/brand-assets/white_bg/icons_navigation). */
...
export const icons = {
    ...
    navigation: named('white_bg/icons_navigation', navigationIconNames),
}
