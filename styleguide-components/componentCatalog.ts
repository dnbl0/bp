...
export const componentLayers: ComponentLayer[] = [
    ...
    },
    {
        ...
        components: [
            ...
            { name: 'ContactCardBlock', source: 'components/molecules/blocks/ContactCardBlock.tsx', description: 'A card presenting contact details and actions.', status: 'stable', docSlug: 'components/contact-card' },
            ...
            { name: 'NearbyCardBlock', source: 'components/molecules/blocks/NearbyCardBlock.tsx', description: 'A card surfacing nearby aged-care homes.', status: 'stable', docSlug: 'components/group-tools' },
            ...
            { name: 'PricingBlock', source: 'components/molecules/blocks/PricingBlock.tsx', description: 'Displays aged-care pricing information.', status: 'stable', docSlug: 'components/group-tools' },
            { name: 'PricingCalculatorBlock', source: 'components/molecules/blocks/PricingCalculatorBlock.tsx', description: 'An interactive cost-of-care calculator.', status: 'stable', docSlug: 'components/group-tools' },
