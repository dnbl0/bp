...
export const componentLayers: ComponentLayer[] = [
    ...
    },
    {
        ...
        components: [
            ...
            { name: 'AccordionBlock', source: 'components/molecules/blocks/AccordionBlock', description: 'A list of expandable/collapsible question-and-answer panels.', status: 'in-review' },
            ...
            { name: 'TestimonialCardBlock', source: 'components/molecules/blocks/TestimonialCardBlock.tsx', description: 'A card presenting a customer testimonial.', status: 'in-review' },
            ...
            { name: 'BreadCrumbsBlock', source: 'components/molecules/blocks/BreadCrumbsBlock.tsx', description: 'Breadcrumb navigation for the current page.', status: 'in-review' },
    ...
    },
    {
        ...
        components: [
            { name: 'BasicHeroSection', source: 'components/molecules/sections/BasicHeroSection.tsx', description: 'A standard page hero band.', status: 'in-review' },
            { name: 'ContactHeroSection', source: 'components/molecules/sections/ContactHeroSection.tsx', description: 'A hero with contact-oriented calls to action.', status: 'in-review' },
            { name: 'SearchHomeHeroSection', source: 'components/molecules/sections/SearchHomeHeroSection', description: 'The homepage hero with integrated search.', status: 'in-review' },
            { name: 'ThreeColumnSearchHeroSection', source: 'components/molecules/sections/ThreeColumnSearchHeroSection.tsx', description: 'A three-column hero with search.', status: 'in-review' },
            { name: 'BannerSection', source: 'components/molecules/sections/BannerSection.tsx', description: 'A promotional banner band.', status: 'in-review' },
            { name: 'OneColumnSection', source: 'components/molecules/sections/OneColumnSection.tsx', description: 'A single-column content band.', status: 'in-review' },
            { name: 'TwoColumnSection', source: 'components/molecules/sections/TwoColumnSection.tsx', description: 'A two-column content band.', status: 'in-review' },
            { name: 'Section12', source: 'components/molecules/sections/Section12.tsx', description: 'A 12-unit grid band.', status: 'in-review' },
            { name: 'Section6x6', source: 'components/molecules/sections/Section6x6.tsx', description: 'A two-up (6+6) grid band.', status: 'in-review' },
            { name: 'Section4x8', source: 'components/molecules/sections/Section4x8.tsx', description: 'An asymmetric (4+8) grid band.', status: 'in-review' },
            { name: 'Section4x4x4', source: 'components/molecules/sections/Section4x4x4.tsx', description: 'A three-up (4+4+4) grid band.', status: 'in-review' },
            { name: 'Section3x3x3x3', source: 'components/molecules/sections/Section3x3x3x3.tsx', description: 'A four-up (3+3+3+3) grid band.', status: 'in-review' },
            { name: 'RegionListDetailSection', source: 'components/molecules/sections/RegionListDetailSection.tsx', description: 'A list/detail layout for browsing regions.', status: 'in-review' },
