import{j as t}from"./jsx-runtime-BYYWji4R.js";import{B as i}from"./BenefitCard-ak2smjab.js";import{b as o}from"./dashboard-PpIkkDYV.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icons-CO6p2nHe.js";const w={title:"Composition/BenefitCard",component:i,parameters:{layout:"centered",docs:{description:{component:`
...
- Hover lifts the card 4px and scales media 1.05× over 600ms.
        `.trim()}}}},v=o.find(e=>e.id==="valet"),b=o.find(e=>e.id==="on-demand"),a={render:()=>t.jsx("div",{style:{width:"100%",maxWidth:320,margin:"0 auto"},children:t.jsx(i,{benefit:v,ctaLabel:"Book now",onClick:()=>{}})})},n={render:()=>t.jsx("div",{style:{width:"100%",maxWidth:320,margin:"0 auto"},children:t.jsx(i,{benefit:b})})},r={name:"Three-up grid",render:()=>t.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:24,maxWidth:1080},children:o.map(e=>t.jsx(i,{benefit:e,ctaLabel:e.id==="valet"?"Book now":"Redeem",onClick:e.id!=="on-demand"?()=>{}:void 0},e.id))}),parameters:{layout:"padded"}};var d,s,c;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => <div style={{
    width: "100%",
    maxWidth: 320,
    margin: "0 auto"
...
}`,...(l=(p=n.parameters)==null?void 0:p.docs)==null?void 0:l.source}}};var u,h,f;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: "Three-up grid",
  render: () => <div style={{
    display: "grid",
...
}`,...(f=(h=r.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};const T=["Interactive","Static","ThreeUp"];export{a as Interactive,n as Static,r as ThreeUp,T as __namedExportsOrder,w as default};
