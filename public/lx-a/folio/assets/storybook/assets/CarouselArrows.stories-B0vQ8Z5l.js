import{j as e}from"./jsx-runtime-BYYWji4R.js";import{C as P,b as w}from"./icons-CO6p2nHe.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";function r({canPrev:s,canNext:b,onPrev:x,onNext:f,prevLabel:N="Previous",nextLabel:y="Next",className:g=""}){return e.jsxs("div",{className:`carousel-nav ${g}`.trim(),children:[e.jsx("button",{type:"button",className:"roundbtn roundbtn--sm",onClick:x,disabled:!s,"aria-label":N,children:e.jsx(P,{width:15,height:15})}),e.jsx("button",{type:"button",className:"roundbtn roundbtn--sm",onClick:f,disabled:!b,"aria-label":y,children:e.jsx(w,{width:15,height:15})})]})}try{r.displayName="CarouselArrows",r.__docgenInfo={description:`Shared prev/next control for every carousel (offers, vehicle panel, …).
