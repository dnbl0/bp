window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "legal_name": "Lexus Group",
    "privacy_policy_url": "https://www.lexus.com.au/smallprint/privacy",
    "deferred_page_contents": [],
    "record_targeting_rules": [],
    "heatmaps": [],
    "polls": [{
        "id": 1866278,
        "created_epoch_time": 1780532430,
        "skin": "light",
        "background": "#f6f5f3",
        ...
        "content": {
            "version": 2,
            "questions": [{
                "uuid": "5a02eb3a-2635-4727-8c9f-e8b7fd8225c7",
                "type": "single-open-ended-multiple-line",
                "text": "What additional information about Lexus Connected Services would make this page more useful for you?",
                "required": true,
                "next": "byOrder"
            }],
            "thankyou": "Thank you for completing this survey.\nIf you would like to discuss your survey response in detail, please go to: https://www.lexus.com.au/contact"
        },
        ...
        "uuid": "c1c9028a-2c7c-4e8c-ad51-14b591341142",
        "invite": {
        ...
        "content": {
            "version": 2,
            "questions": [{
                "uuid": "33633749-d16d-4e3a-89ef-9266f1107e4b",
                "type": "reaction",
                "text": "How would you rate the Lexus Encore App?",
                "required": true,
                "labels": [{
                ...
                "nextByAnswer": ["question:ee9f0f87-106c-4b98-8cea-bae48a12a293", "question:ee9f0f87-106c-4b98-8cea-bae48a12a293", "question:19ae3f5b-ecde-44a9-bc07-e1548de9cfa8"],
                "next": "byAnswer",
                "reaction_style": "star"
            }, {
                "uuid": "ee9f0f87-106c-4b98-8cea-bae48a12a293",
                "type": "single-open-ended-multiple-line",
                "text": "Is there anything about your experience that you would like to share?",
                "required": false,
                "nextIfSkipped": "thankYou",
                "next": "thankYou"
            }, {
                "uuid": "19ae3f5b-ecde-44a9-bc07-e1548de9cfa8",
                "type": "single-open-ended-multiple-line",
                "text": "Is there anything about your experience that you would like to share?",
                "required": false,
                "nextIfSkipped": "question:ff656235-e15b-4fe2-89e8-8d6574e7cd40",
                "next": "question:ff656235-e15b-4fe2-89e8-8d6574e7cd40"
            }, {
                "uuid": "ff656235-e15b-4fe2-89e8-8d6574e7cd40",
                "type": "title-and-description",
                "text": "If you have a moment...",
                "required": true,
                "description": "We would love it if you could also share your feedback on the app store: https://apps.apple.com/au/app/lexus/id1480479318",
                "next": "thankYou"
            }],
            "thankyou": "Thank you for completing this survey"
        },
        ...
        "uuid": "2f0cf269-702f-4ecf-8bca-015af8616d69",
        "invite": {
            "title": "Your feedback is important to us!",
            "description": "Tell us what you think about this page by taking our quick Survey.",
            "button": "Yes, I will give feedback",
        ...
        "content": {
            ...
            "questions": [{
                "uuid": "5a02eb3a-2635-4727-8c9f-e8b7fd8225c7",
                "type": "single-open-ended-multiple-line",
                "text": "What additional information about Lexus Hybrid vehicles would make this page more useful for you?",
                "required": true,
                "next": "byOrder"
            }],
            "thankyou": "Thank you for completing this survey.\nIf you would like to discuss your survey response in detail, please go to: https://www.lexus.com.au/contact"
        ...
        "uuid": "3a73262c-4083-4d65-88fa-6db4f9f2a419",
        "invite": {
            "title": "Your feedback is important to us!",
            "description": "Tell us what you think about this page by taking our quick Survey.",
            "button": "Yes, I will give feedback",
        ...
        "content": {
            "version": 2,
            "questions": [{
                "uuid": "bb76c631-b400-483f-a3e4-cc216a2f1773",
                "type": "single-open-ended-multiple-line",
                "text": "We've noticed you haven't completed your brochure request. Is there anything we could improve to make the process easier?",
                "required": true,
                "next": "thankYou"
            }],
            "thankyou": "Thank you for completing this survey.\nIf you would like to discuss your survey response in detail, please go to: https://www.lexus.com.au/contact"
        ...
        "targeting": [{
            ...
            "match_operation": "exact",
            "negate": false,
            "pattern": "brochureabandonex",
            "name": null,
            "rule_type": null
        }],
        "uuid": "c3e0113d-8a98-4bde-a39a-36e583b84632",
        "invite": {
            "title": "Your feedback is important to us!",
            "description": "Tell us what you think about this page by taking our quick Survey.",
            "button": "Yes, I will give feedback",
        ...
        "uuid": "520647a5-5f4c-4a1d-96ad-0281a8611606",
        "invite": {
            "title": "Your feedback is important to us!",
            "description": "Tell us what you think about this page by taking our quick Survey.",
            "button": "Yes, I will give feedback",
    ...
    "cs_tag_name": null,
    "account_id": 1634450,
    "account_signature": "0c619bd68e6b8d8cd87ff9fdeb491bb641a505115f9d86f13fd9358c241b046d"
};
...
! function() {
            ...
            count: function(e, t) {
                ...
                try {
                    var u, l = d(r),
                        f = c.loggedMetrics[e],
                        p = 0;
                    if (n ? (p = (f && f[l] || 0) + (n.value || 1), c.loggedMetrics[e] = a(a({}, f), {}, ((u = {})[l] = null != n && n.flush ? 0 : p, u))) : p = 1, h(s, n)) {
                        var v = {
                            name: e,
                            type: "count",
                            value: p,
    ...
    function C() {
        ...
        var r, i, a, o, s, u, c, l, d, g, h, f, w = !(!window.CS_CONF || null === (e = window.CS_CONF.voc) || void 0 === e || !e.enabled),
        ...
        if (w && window._uxa) window._uxa.push(["start:hotjar", hjSiteSettings]), window.hj.scriptLoaded = !0;
            ...
            var y = (u = (r = hjSiteSettings).suppress_all || r.suppress_text || (null === (i = r.suppress_all_on_specific_pages) || void 0 === i ? void 0 : i.length), c = function(e) {
                    ...
                    return o
                }(r), l = c.anonymisationMethod, d = c.replayRecordingMaskedUrlRegex, g = c.replayRecordingMaskedUrlRegexRules, h = !(null === (a = _hjSettings) || void 0 === a || !a.environment || "live" === _hjSettings.environment), {
                    CS_CONF_BASE: {
                        ...
                        implementations: (s = r, T(E, (f = s.state_change_listen_mode, "manual" === f ? [] : [{
                            template: {
            ...
            }, window.hjBootstrap(e, t, n), window.hjBootstrap.revision = "94c567d";
            var c = window.document,
                l = c.head || c.getElementsByTagName("head")[0];
            hj.scriptDomain = e;
            var d = c.createElement("script");
            d.async = !0, d.src = hj.scriptDomain + t, d.charset = "utf-8", l.appendChild(d)
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.87d8c9dd104c309e4245.js", "2514697")
    }
