/* eslint-disable */
const NEW_RELIC_NAME = "NREUM";
const typeQs = new URLSearchParams(window.location.search).get("type");
if (process.env.NEW_RELIC_APP_ID && process.env.NEW_RELIC_APP_ID !== "false" && typeQs !== "iframe") {
    let NREUM = {};
    NREUM.init = {
        distributed_tracing: {
            enabled: true
    ...
    NREUM.loader_config = {
        accountID: "955740",
        trustKey: "955740",
        agentID: process.env.NEW_RELIC_APP_ID,
        licenseKey: "4b01e197f4",
    ...
    (() => {
            ...
            r = {
                ...
                6562: (e, t, r) => {
                    ...
                    if (navigator.userAgent) {
                        ...
                        S && -1 === x.indexOf("Chrome") && -1 === x.indexOf("Chromium") && ((T = "Safari"), (O = S[1]));
                    }
                    ...
                    function _(e, t) {
                        ...
                        if (!t) return !0;
                        if (!O) return !1;
                        for (let r = O.split("."), n = t.split("."), i = 0; i < n.length; i++)
                            if (n[i] !== r[i]) return !1;
                        return !0;
                    }
                    let I = r(5526),
                ...
                6368: (e, t, r) => {
                    ...
                    function o(e) {
                        ...
                        let s = !t.protocol || ":" === t.protocol || t.protocol === r.protocol,
                        ...
                        for (var t = !1, r = !1, n = 0; n < e.length; n++) {
                            "regex" in e[n] ?
                                ...
                                ((0, a.Z)(
                                    ...
                                    (r = !0)) :
                                ((0, a.Z)('An obfuscation replacement rule was detected missing a "regex" value.'),
                                    (r = !0));
                            let i = e[n].replacement;
                            i &&
                                "string" !== typeof i &&
                                ((0, a.Z)(
                ...
                6797: (e, t, r) => {
                    ...
                    function c(e, t, r) {
                        ...
                        const o = i.initializedAgents || {},
                            s = o[e] || {};
                        return (
                            Object.keys(s).length || (s.initializedAt = {
                                ms: (0, n.zO)(),
                                date: new Date()
                            }),
                ...
                6998: (e, t, r) => {
                    ...
                    function i(e) {
                        ...
                        return void(0, n.iz)("visibilitychange", () => {
                            if (t) {
                ...
                7264: (e, t, r) => {
                    ...
                    function l(e, t, r) {
                        ...
                        for (let n in e) c.call(e, n) && (t[n] = e[n]);
                        return t;
                    }
                    ...
                    function T(e) {
                        ...
                        return (
                            ...
                            t.on(g + "end", function(e, r) {
                                let n = this;
                                if (r) {
                                    let i = r.headers.get("content-length");
                    ...
                    function C(e) {
                        const t = k(e);
                        1 == S[t.debugId] ? (R.forEach(e => p(a._A, e)), (S[t.debugId] = 1 / 0)) : S[t.debugId]--;
                    }
                    ...
                    function G(e) {
                        const t = q(e);
                        return !a.il || F[t.debugId]++ || ((F[t.debugId] = 1), d(t).inPlace(window.history, U, "-")), t;
                    }
                        ...
                        return (
                            ...
                            t.on("dom-start", e => {
                                !(function(e) {
                                    ...
                                    let o = ((a = e.src), (c = a.match(n)), c ? c[1] : null);
                                    let a, c;
                                    if (!o) return;
                                    let u = (function(e) {
                                        let t = e.match(i);
                    ...
                    function Y(e) {
                        const t = Q(e);
                        !0 === X[t.debugId] && (Z.forEach(e => p(Node.prototype, e)), (X[t.debugId] = "unwrapped"));
                    }
                    ...
                    function te(e) {
                        const t = re(e);
                        !0 === K[t.debugId] && ((window.MutationObserver = J.Yu.MO), (K[t.debugId] = "unwrapped"));
                    }
                        ...
                        return (
                            ...
                            (function() {
                                ...
                                Object.defineProperty(e, "name", {
                                    ...
                                    Object.setPrototypeOf(e, o), ["all", "race"].forEach(r => {
                                        const n = o[r];
                                        e[r] = function(e) {
                                            let i = !1;
                                            e ? .forEach(e => {
                    ...
                    function le(e) {
                        ...
                        return (
                            "getPrototypeOf" in Object && (a.il && he(document, n), he(a._A, n), he(ue.prototype, n)),
                            t.on(de + "-start", function(e, t) {
                                let n = e[1];
                                if (null !== n && ("function" === typeof n || "object" === typeof n)) {
                                    let i = (0, se.X)(n, "nr@wrapped", () => {
                                        let e = {
                                            object: function() {
                    ...
                    function ye(e) {
                        ...
                        function E() {
                            for (let e = 0; e < h.length; e++) v(0, h[e]);
                            h.length && (h = []);
                        }
                ...
                948: (e, t, r) => {
                    ...
                    class m {
                        ...
                        generateTracePayload(e) {
                            ...
                            let t = (0, n.DL)(this.agentIdentifier);
                            if (!t) return null;
                            let r = (t.accountID || "").toString() || null,
                        ...
                        isAllowedOrigin(e) {
                            ...
                            if (
                                ...
                                for (let i = 0; i < r.allowed_origins.length; i++) {
                                    let o = (0, g.e)(r.allowed_origins[i]);
                        ...
                        isDtEnabled() {
                            let e = (0, n.Mt)(this.agentIdentifier, "distributed_tracing");
                            return !!e && !!e.enabled;
                        }
                                ...
                                ((this.dt = new m(e)),
                                    ...
                                    (function(e, t, r, i) {
                                        ...
                                        function c(t, r) {
                                            ...
                                            let a = i.generateTracePayload(this.parsedOrigin);
                                            if (a) {
                                                let s = !1;
                                                a.newrelicHeader &&
                                        ...
                                        function O(e, r) {
                                            this.xhrCbStart &&
                                                t.emit(
                                                    "xhr-cb-time", [(0, h.zO)() - this.xhrCbStart, this.onload, r],
                                                    r
                                                );
                                        }
                                        ...
                                        function j(e) {
                                            ...
                                            let n = i.generateTracePayload(this.parsedOrigin);
                                        ...
                                        function P(e, t) {
                                            ...
                                            r(
                                                "xhr", [this.params, i, this.startTime, this.endTime, "fetch"],
                                                this,
                                                w.D.ajax
                                            );
                                        }
                                            ...
                                            if (!this.ended) {
                                                ...
                                                t.aborted ||
                                                    ((n.duration = (0, h.zO)() - this.startTime),
                                                        ...
                                                        r(
                                                            "xhr", [t, n, this.startTime, this.endTime, "xhr"],
                                                            this,
                                                            w.D.ajax
                                                        ));
                                            }
                                        ...
                                        function C(e, t) {
                                            ...
                                            if ((r && (e.metrics.rxSize = r), e.sameOrigin)) {
                                                let n = t.getResponseHeader("X-NewRelic-App-Data");
                ...
                9715: (e, t, r) => {
                    ...
                    try {
                        ...
                        console &&
                            ...
                            ((l.console = !0), -1 !== n.indexOf("dev") && (l.dev = !0), -1 !== n.indexOf("nr_dev") && (l.nrDev = !0));
                    } catch (e) {}
                    ...
                    l.nrDev &&
                        d.ee.on("internal-error", e => {
                            h(e.stack);
                        }),
                        l.dev &&
                        d.ee.on("fn-err", (e, t, r) => {
                            h(r.stack);
                        }),
                        l.dev &&
                    ...
                    class x extends p.S {
                        ...
                        onerrorHandler(e, t, r, n, a) {
                            ...
                            return (
                                "function" === typeof this.origOnerror && this.origOnerror.apply(this, u()(arguments))
                            );
                        }
                    }
                        ...
                        try {
                            (function() {
                                try {
                                    ...
                                    for (let e = document.querySelectorAll("body > div"), t = 0; t < e.length; t++)
                    ...
                    class O extends o.S {
                            ...
                            singleChecks() {
                                ...
                                t.length > 0 && this.recordSupportability("Generic/Obfuscate/Detected"),
                                    t.length > 0 && !(0, d.Ng)(t) && this.recordSupportability("Generic/Obfuscate/Invalid"),
                                    (function(e) {
                                        if (!m) {
                                            if (v.dedicated) {
                                                let t;
                                                    ...
                                                    try {
                                                        a._A.navigator.serviceWorker.register =
                                                            ((t = y),
                                                                function() {
                                                                    for (
                                                                        var e = arguments.length, r = new Array(e), n = 0; n < e; n++
                                                                    )
                                                                        r[n] = arguments[n];
                                                                    return (
                                                                        i("Service", r[1] ? .type),
                    ...
                    class g extends f.S {
                            ...
                            perfObserver(e, t) {
                                e.getEntries().forEach(e => {
                                    "first-paint" === e.name ?
                                        (0, a.p)(
                                            "timing", ["fp", Math.floor(e.startTime)],
                                            void 0,
                                            h.D.pageViewTiming,
                                            this.ee
                                        ) :
                                        ...
                                        (0, a.p)(
                                            "timing", ["fcp", Math.floor(e.startTime)],
                                            void 0,
                                            h.D.pageViewTiming,
                                            this.ee
                                        );
                            ...
                            addConnectionAttributes(e) {
                                let t = navigator.connection || navigator.mozConnection || navigator.webkitConnection;
                                if (t)
                                    return (
                    ...
                    class N extends c.S {
                        constructor(e, t) {
                            ...
                            r.on(b, function(e, t) {
                                ...
                                (0, o.W)() ?
                                ((0, n.p)(
                                        h, [window.performance.getEntriesByType("resource")],
                                        void 0,
                                        d.D.sessionTrace,
                                        r
                                    ),
                                    (function() {
                                        let e = new PerformanceObserver((e, t) => {
                                            let i = e.getEntries();
                        ...
                        onResourceTimingBufferFull(e) {
                            if (
                                ((0, n.p)(
                                        h, [window.performance.getEntriesByType(E)],
                                        void 0,
                                        d.D.sessionTrace,
                                        this.ee
                                    ),
                        ...
                        importAggregator() {
                            ...
                            const e = async () => {
                                try {
                                    const {
                                        lazyLoader: e
                                    } = await r.e(729).then(r.bind(r, 8110)), {
                                        Aggregate: t
                ...
                2384: (e, t, r) => {
                    ...
                    function y(e) {
                        ...
                        return (
                            ...
                            h.v6 && (E.jsAttributes = { ...E.jsAttributes,
                                isWorker: !0
                            }),
                            (0, a.CX)(e, E),
                            (0, a.Dg)(e, w || {}),
                            ...
                            (function(e, t, n) {
                                ...
                                function A(e, t, r, n) {
                                    return function() {
                                        return (
                                            (0, s.p)(
                                                "record-supportability", ["API/" + t + "/called"],
                                                void 0,
                                                o.D.metrics,
                                                v
                                            ),
                                            (0, s.p)(
                                                e + t, [(0, d.zO)()].concat(i()(arguments)),
                                                r ? null : this,
                                                n,
                                                v
                                            ),
                                ...
                                (t.noticeError = function(e, t) {
                                    "string" === typeof e && (e = new Error(e)),
                                        (0, s.p)(
                                            "record-supportability", ["API/noticeError/called"],
                                            void 0,
                                            o.D.metrics,
                                            v
                                        ),
                                ...
                                (0, v.EZ)("setToken", t =>
                                    (function(e, t) {
                                        ...
                                        e &&
                                            "object" === typeof e &&
                                            ((0, c.D)(e, (e, t) => {
                                                    if (!t) return (0, s.p)("block-" + e, [], void 0, m[e], r);
                                                    t && !b[e] && ((0, s.p)("feat-" + e, [], void 0, m[e], r), (b[e] = !0));
                                                }),
        ...
        (i.d = (e, t) => {
            for (let r in t) i.o(t, r) && !i.o(e, r) && Object.defineProperty(e, r, {
                enumerable: !0,
                get: t[r]
            });
        }),
        ...
        (i.l = (r, n, o, a) => {
            if (e[r]) e[r].push(n);
                ...
                var l = (t, n) => {
                        ...
                        let i = e[r];
                        if (
                            (delete e[r], s.parentNode && s.parentNode.removeChild(s), i && i.forEach(e => e(n)), t)
                        )
                            return t(n);
                    },
            ...
            i.f.j = (t, r) => {
                ...
                if (0 !== n)
                    if (n) r.push(n[2]);
                        ...
                        let o = new Promise((r, i) => (n = e[t] = [r, i]));
                        r.push((n[2] = o));
                        let a = i.p + i.u(t),
                            s = new Error();
                        i.l(
                            ...
                            r => {
                                if (i.o(e, t) && (0 !== (n = e[t]) && (e[t] = void 0), n)) {
                                    let o = r && ("load" === r.type ? "missing" : r.type),
                ...
                start() {
                    ...
                    try {
                        ...
                        this.desiredFeatures.forEach(e => {
                                if (t[e.featureName]) {
                                    ...
                                    r.every(e => t[e]) ||
                                        ...
                                        (this.features[e.featureName] = new e(this.agentIdentifier, this.sharedAggregator));
                                }
                            }),
                        ...
                        return (
                            ...
                            delete r.ee ? .get(this.agentIdentifier), !1
                        );
                    }
                }
            })({
