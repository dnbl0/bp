(function() {
    ...
    r("Promise", function(a) {
        ...
        b.race = function(f) {
            return new b(function(e, g) {
                for (var l = x(f), m = l.next(); !m.done; m = l.next()) d(m.value).B(e, g)
            })
        };
        b.all = function(f) {
            var e = x(f),
            ...
            return g.done ? d([]) : new b(function(l, m) {
                ...
                var w = [],
                    z = 0;
                do w.push(void 0), z++, d(g.value).B(u(w.length - 1), m), g = e.next(); while (!g.done)
            })
        };
        return b
    });
    ...
    */
    ...
    n.F = function(a) {
        ...
        if (b) {
            var c = this.h[b];
            this.o != 0 ? (this.l.push(a), this.g[a + 1] = function() {}) : (c && na(c, a), delete this.g[a], delete this.g[a + 1], delete this.g[a + 2])
        }
        return !!b
    };
    n.G = function(a, b) {
        ...
        if (c) {
            ...
            if (this.A)
                for (k = 0; k < c.length; k++) h = c[k], La(this.g[h + 1], this.g[h + 2], d);
            else {
                this.o++;
                try {
    ...
    function fb(a, b) {
        ...
        for (var c = b.next(), d = {}; !c.done; d = {
                m: void 0
            }, c = b.next()) d.m = c.value, a[d.m] || (d.m === "getCurrentTime" ? a[d.m] = function() {
    ...
    function cb(a, b, c) {
        Z || (Z = {}, gb = new Set, ib.addEventListener("message", function(d) {
            a: if (gb.has(d.origin)) {
                ...
                var k = Z[h.id];
                if (k && d.origin === k.O) switch (d = k.S, d.o = !0, d.o && (E(d.l, d.sendMessage, d), d.l.length = 0), k = h.event, h = h.info, k) {
                    case "apiInfoDelivery":
                        if (B(h))
                            for (var f in h) h.hasOwnProperty(f) && (d.u[f] = h[f]);
                        break;
                    case "infoDelivery":
                        eb(d, h);
                        break;
                    case "initialDelivery":
                        B(h) && (clearInterval(d.h), d.playerInfo = {}, d.u = {}, fb(d, h.apiInterface), eb(d, h));
                        break;
