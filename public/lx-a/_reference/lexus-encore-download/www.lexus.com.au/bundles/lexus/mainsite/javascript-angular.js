...
(function(y) {
    ...
    function qe(a) {
        if (G(a)) u(a.objectMaxDepth) && (Oc.objectMaxDepth = Wb(a.objectMaxDepth) ? a.objectMaxDepth : NaN);
        else return Oc
    }
    ...
    function jd(a, b, d, c) {
        ...
        if (f)
            if (b) {
                ...
                for (b in e) "$destroy" !== b && a.removeEventListener(b,
                    f), delete e[b]
    }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a,
            ...
            function sc(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        G(g) && (g = g.animVal);
                        if (F(g) && "" !== g)
                            for (; a = k.exec(g);) h = Da(a[2]), X(b, h, "C", d, e) && (c[h] = Q(a[3])), g = g.substr(a.index + a[0].length);
                        break;
                    case Ma:
                        ma(b, a.nodeValue);
                        break;
            ...
            function Y(a, b, d, e, g, f, h, k, l) {
                ...
                for (var n = -Number.MAX_VALUE, H = l.newScopeDirective, w = l.controllerDirectives, O = l.newIsolateScopeDirective, A = l.templateDirective, s = l.nonTlbTranscludeDirective, T = !1, E = !1, qa = l.hasElementTranscludeDirective, v = d.$$element = z(b), t, L, V, r = e, ua, la = !1, u = !1, y, Ca = 0, Oa = a.length; Ca < Oa; Ca++) {
                    ...
                    if (y = t.transclude)
                        if (T = !0, t.$$tlb || ($("transclusion", s, t, v), s = t), "element" === y) qa = !0, n = t.priority, V = v, v = d.$$element = z(ba.$$createComment(L, d[L])), b = v[0], ja(g, xa.call(V, 0), b), V[0].$$parentNode = V[0].parentNode, r = U(u, V, e, n, f && f.name, {
            ...
            rc.prototype = {
                ...
                $set: function(a, b, d, e) {
                    ...
                    e ? this.$attr[a] = e : (e = this.$attr[a]) || (this.$attr[a] = e = Xc(a,
                        "-"));
                    g = ya(this.$$element);
                    if ("a" === g && ("href" === a || "xlinkHref" === a) || "img" === g && "src" === a) this[a] = b = null == b ? b : r(b, "src" === a);
    ...
    function Bg(a, b, d, c, e) {
        ...
        return function(e, k, h, l, m, p, n, B, v, E) {
            ...
            k = k || a.url();
            if ("jsonp" === N(e)) var J = c.createCallback(k),
            ...
            else p && C(p.then) && p.then(function() {
        ...
        this.$get = ["$parse", "$exceptionHandler",
            ...
            function(d, c, e) {
                ...
                function h(f, h, p, n) {
                    ...
                    for (var t = [], r = []; H < J;)
                        if (-1 !== (q = f.indexOf(a,
                                H)) && -1 !== (w = f.indexOf(b, q + l))) H !== q && t.push(g(f.substring(H, q))), H = f.substring(q + l, w), K.push(H), T.push(d(H, s)), H = w + m, r.push(t.length), t.push("");
                        else {
            ...
            f.on("click", function(a) {
                ...
                if (e && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 !== a.which && 2 !== a.button) {
                    ...
                    if (!F(e) || !x(h.attr(e))) {
                        ...
                        v.test(e) || !e || h.attr("target") || a.isDefaultPrevented() || !l.$$parseLinkUrl(e, k) || (a.preventDefault(), l.absUrl() !== c.url() && (d.$apply(), g.angular["ff-684208-preventDefault"] = !0))
                    }
                }
            });
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function(f, g, k) {
            ...
            m.prototype = {
                ...
                $watchCollection: function(a,
                    ...
                    function c(a) {
                        ...
                        if (!x(e)) {
                            if (G(e))
                                if (ja(e))
                                    for (f !== p && (f = p, q = f.length = 0, l++), a = e.length, q !== a && (l++, f.length = q = a), b = 0; b < a; b++) h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (l++, f[b] = g);
                                else {
                                    f !== n && (f = n = {}, q = 0, l++);
                                    a = 0;
                            ...
                            if (n = !w.$$suspended && w.$$watchers)
                                for (n.$$digestWatchIndex = n.length; n.$$digestWatchIndex--;) try {
                                    if (a =
                                        ...
                                        if (m = a.get, (g = m(w)) !== (h = a.last) && !(a.eq ? sa(g, h) : X(g) && X(h))) q = !0, c = a, a.last = a.eq ? na(g, null) : g, l = a.fn, l(g, h === v ? g : h, w), 5 > B && (z = 4 - B, A[z] || (A[z] = []), A[z].push({
                ...
                $on: function(a, b) {
                    ...
                    var e = this;
                    return function() {
                        var d = c.indexOf(b); - 1 !== d && (delete c[d], B(e, 1, a))
                    }
                },
                $emit: function(a, b) {
                    var c = [],
        ...
        switch (g) {
            case "object":
                ...
                if ("object" ===
                    k) {
                    for (h in b)
                        if (f = b[h], !C(f) && !x(f) && (g = h === c, !ga(g ? a : a[h], f, d, c, g, g))) return !1;
                    return !0
                }
                return d(a, b);
            case "function":
            ...
            search: function(a, b) {
                switch (arguments.length) {
                    ...
                    case 1:
                        ...
                        else if (G(a)) a = na(a, {}), q(a, function(b, c) {
                            null == b && delete a[c]
                        }), this.$$search = a;
                    ...
                    return function(a, d, f, g, l) {
                        ...
                        a.$watchCollection(p, function(f) {
                            ...
                            if (ja(f)) F =
                                ...
                                for (G in p = s || z, F = [], f) ra.call(f, G) && "$" !== G.charAt(0) && F.push(G);
                            w = F.length;
                            G = Array(w);
                            for (g = 0; g < w; g++)
                                if (B = f === F ? g : F[g], y = f[B], C = p(B, y, g), m[C]) D = m[C], delete m[C], A[C] = D, G[g] = D;
                                else {
                            ...
                            for (t in m) {
                                ...
                                b.leave(C);
                                if (C[0].parentNode)
                                    for (g = 0, p = C.length; g < p; g++) C[g].$$NG_REMOVED = !0;
                                D.scope.$destroy()
                            }
                            for (g = 0; g < w; g++)
