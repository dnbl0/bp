/* clarity-js v0.8.66: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    ...
    t = 0, e = "0.8.66", n = /\S/gi, a = 2048, i = !0, r = null, o = null, u = null, c = null, l = null, s = !1, d = null, f = null, h = null, g = 0, v = 0, m = null, y = null, b = "CompressionStream" in window, w = null, k = {}, S = new Set, E = {}, T = {}, N = {}, M = {}, _ = null, O = "^", x = null, I = [{
        start: function() {
            s = !1, Hn()
        },
        stop: function() {
        ...
        start: function() {
            ...
            Ge = f.indexOf("Electron") > 0 ? 1 : 0, l = {
                ...
                upgrade: null,
                upload: ""
            }, (s = va("_clsk", !xn.includeSubdomains)) && (c = s.includes("^") ? s.split("^") : s.split("|")).length >= 5 && l.ts - ao(c[1]) < 18e5 && (l.session = c[0], l.count = ao(c[2]) + 1, l.upgrade = ao(c[3]), l.upload = c.length >= 6 ? "https://" + c[5] + "/" + c[4] : "/" === c[4][0] ? c[4] : "https://" + c[4]), a = l, i = io(), r = xn.projectId || An(location.host), Je = {
                projectId: r,
                userId: i.id,
                sessionId: a.session,
                pageNum: a.count
