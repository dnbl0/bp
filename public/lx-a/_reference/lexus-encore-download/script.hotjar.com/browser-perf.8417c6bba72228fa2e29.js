! function() {
    ...
    var i, u = ["longtask", "resource"],
        a = function() {
            function e(n) {
                var o = this;
                if (function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), this.measures = [], this.subscription = new Map, !("PerformanceObserver" in window) || !("performance" in window) || ! function() {
                        return "PerformanceObserver" in window && u.every((function(e) {
                ...
                this.observer = new PerformanceObserver((function(e) {
                    e.getEntries().forEach((function(e) {
                        var i, u, a = [];
                        if ("longtask" === e.entryType) i = "longtask", a.push({
                            name: i,
                            ...
                            var s = null == n ? void 0 : n.some((function(t) {
                                return e.name.includes(t)
                            }));
                            "script" === e.initiatorType && s ? (i = "resource_timing", a.push({
                                name: i,
                            ...
                            })) : "xmlhttprequest" === e.initiatorType && s && (i = !e.responseStatus || e.responseStatus >= 200 && e.responseStatus < 400 ? "request_latency" : "request_error", a.push({
                                name: i,
                                startTime: e.fetchStart,
                                duration: e.responseEnd - e.fetchStart,
                                detail: {
                        ...
                        a.length && (o.measures = [].concat(a, function(e, t, n) {
                            if (t && !Array.isArray(t) && "number" == typeof t.length) {
                                var o = t.length;
                                return r(t, o)
                            }
                            return e(t, n)
                        }(t, o.measures)), i && o.subscription.has(i) && (null === (u = o.subscription.get(i)) || void 0 === u || u(a, e)))
                    }))
                }))
            }
            var o, i;
            ...
            }], i && n(o.prototype, i), Object.defineProperty(o, "prototype", {
                writable: !1
            }), e
        }(),
        s = function(e) {
        ...
        c = function(e) {
            e.forEach((function(e) {
                ...
                null != n && n.includes("hotjar") ? r = "hotjar-js" : null != n && n.includes("modules") && (r = "modules-js"), r && o && e.startTime > 0 && hj.metrics.timeEnd(o, {
                    tag: {
                        resource: r
                    },
                    total: e.duration,
    ...
    ! function() {
        try {
            ! function() {
                i = new a(["hotjar.com", "hotjar.io"]);
                var e = function() {
                    i.subscribe("resource_timing", c), i.subscribe("request_latency", l), i.subscribe("request_error", f), i.start(["resource"])
                };
